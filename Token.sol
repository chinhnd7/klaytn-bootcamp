...
contract VotingToken {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _initiallSupply) {
        name = _name;
        symbol = _symbol;
        balanceOf[msg.sender] = _initiallSupply;
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        ...
        //  address(0) là 0x0 (địa chỉ không hợp lệ)
